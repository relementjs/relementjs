...
| isomorphic server (base api)               |   678 B   | relement__use server__base__relement     |
...
| server-only minimal                        |   504 B   | tags                                     |
| **server-only render doc + helpers**       | **550 B** | **tags doc_html_ tagsNS _ bind_**        |
